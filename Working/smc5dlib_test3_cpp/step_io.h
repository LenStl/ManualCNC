...
class StepIO
{
	public:
		 ...
		 */
		static StepList^ generateSquare(float min_x, float min_y, float max_x, float max_y, float height, float speed, SMCSettings^ smc_settings);
		 ...
		 */
		static StepList^ generateLine(float start_x, float start_y, float end_x, float end_y, float height, float speed, SMCSettings^ smc_settings);
		 ...
		 */
		static StepList^ generateCircle(float center_x, float center_y, float radius, float height, float speed, unsigned int divisions, SMCSettings^ smc_settings);
		 ...
		 */
		static StepList^ loadGRF(System::String^ file_path, float height, float speed, SMCSettings^ smc_settings);
		 ...
		 * @return A StepList^ of linearly interpolated steps representing the curve defined in file_path.
		 */
		static StepList^ loadBinary(System::String^ file_path, SMCSettings^ smc_settings);
		 ...
		 * @param smc_settings - SMCSettings of the targeted connector.
		 */
		static void writeBinary(System::String^ file_path, StepList^ step_list);
};
